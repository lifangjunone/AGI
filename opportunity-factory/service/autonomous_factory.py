...
def render_wechat_payment_page(order: sqlite3.Row) -> bytes:
    ...
    <section class="payment-layout">
      <div class="panel qr-panel">
        ...
        <p class="notice">电脑端请使用微信扫一扫；手机端可长按二维码识别。请务必填写付款备注，用于匹配到账记录。</p>
      </div>
