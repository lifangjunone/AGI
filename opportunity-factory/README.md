...
不采用个人微信/支付宝静态收款码作为自动支付通道：它不适合网站远程经营收款，也没有可信 webhook，无法安全地自动交付。完整调研与部署选择见 [跨境部署与收款决策](docs/CROSS_BORDER_DEPLOYMENT_AND_PAYMENTS.md)。
...
- 达到 30 个非测试审计后，专业报告申请率低于 5%：停止当前 ¥299 报告方案
- 达到 10 个购买意向后仍无真实支付：调整价格或交付物，不把意向计作收入
