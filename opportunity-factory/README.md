...
左侧经营导航采用“层层递进、逐级扩散”的动态网络：七个阶段沿业务流向展开，动画连线展示数据向收入端流动，并由“复盘复利”回流到“商机确认”。下方业务增长飞轮汇总洞察、验证、成交和复利四个环节，实时显示已推进商机数。
...
“历史报告”在应用内展示最近 30 期档案，按日期形成时间线。选择历史商机后，右侧直接显示当期的证据、阶段任务、成本与盈利模型，不再打开本地文件夹。
