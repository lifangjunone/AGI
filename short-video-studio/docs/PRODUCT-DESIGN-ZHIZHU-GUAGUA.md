...
| Web/PWA | 完整工作台与收费 | 商品内容包、公众号、社群、开单页、批量内容、视频 |
...
开单页作为 Web 端服务变现模块，连接“服务商品化”和“推广内容生产”：用户完成服务定位、报价与买家页后，可将服务信息直接带入朋友圈与社群助手。首期只验证页面发布、分享和推广内容生成，不使用现有支付能力代收个人服务订单；优先通过 Pro 订阅、高级模板和推广内容包变现。
...
- Web 服务变现入口：`/kaidan/`，源码位于相邻 `kaidan-page`，通过构建脚本同步到 `public/kaidan/`
