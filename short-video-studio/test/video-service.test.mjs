...
test("normalizes a short clip to an exact requested duration with ffmpeg", async (t) => {
  try {
  ...
  assert.ok(Math.abs(outputDuration - 5) < 0.08, `Expected 5s, received ${outputDuration}s`);
});
