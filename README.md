...
- `kaidan-page`：新增 ToC 变现产品“开单页”，支持从模板或空白服务开始，定义客户、结果承诺、动态交付项、联系方式和三档报价，补充真实案例、服务保障及 FAQ；提供移动编辑/预览、目标时薪成本价、营收与产能测算、价格梯度提示、发布缺项定位、买家分享链接和含真实联系 CTA 的独立 HTML 导出，当前未接入公网托管、支付和订单。
