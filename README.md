...
- `kaidan-page`：新增 ToC 变现产品“开单页”，支持从高频模板或空白服务开始，定义客户、结果承诺、交付边界、联系方式和三档报价，实时切换移动端编辑/买家预览，测算营收、3% 平台费、Pro 盈亏平衡点与交付产能；现已补齐价格梯度提示、发布缺项定位、保存时间、剪贴板失败反馈、重置确认和含真实联系 CTA 的独立 HTML 导出，当前未接入公网发布、支付和订单。
