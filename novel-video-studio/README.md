...
当前 33 项自动化测试覆盖三端入口、5–60 秒时长拆分、公版推荐目录与 API、演示/真实生成边界、预算门禁、PWA、桌面安全配置、输入约束、任务重试、清单下载和媒体 Range 请求。完整交互测试记录见 [`dogfood-output/report.md`](dogfood-output/report.md)。
